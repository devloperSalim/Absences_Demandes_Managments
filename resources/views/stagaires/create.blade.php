            ...
            <div class="card my-5">
                <div class="card-header">
                    <div class="text-center font-weight-bold text-uppercase">
                        <h4>Create Stagiaire</h4>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('stagaires.store') }}" method="POST" class="mt-3">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="hire_date" class="form-control" placeholder="Hire Date" value="{{ old('hire_date') }}">
                        </div>
