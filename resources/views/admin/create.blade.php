...
<body>
    <div class="">
        <div class="min-h-screen w-full font-sans aliased flex flex-col">
            <div class="flex-1 flex items-center bg-blue-500 py-12 relative">
                <div class="h-1/2 w-full mx-auto absolute inset-x-0 top-0"></div>
                <div class="max-w-xl mx-auto px-8 relative space-y-6">

                    <div class="rounded-lg shadow bg-white overflow-hidden divide-y divide-gray-200">
                        <form method="POST" action="{{ route('admins.store') }}" class="px-8 pb-10 space-y-4">
                            @csrf
                            <h1
                            ...
                            <div>
                                ...
                                <input type="text" id="" name="nom" required="" placeholder=""
                                    autocomplete="current-password"
                                    class="border border-gray-300 w-full shadow-sm mt-1 h-12 p-2" />
                            </div>
                            <div>
                                <label for="nom" class="inline-block text-sm font-medium">
                                    Prenom
                                </label>
                                <input type="text" id="" name="prenom" required="" placeholder=""
                                    autocomplete="current-password"
                                    class="border border-gray-300 w-full shadow-sm mt-1 h-12 p-2" />
                            </div>
                            <div>
                                ...
                                <input type="email" id="email" autofocus="autofocus" required="" name="email"
                                    autocomplete="email" class="border border-gray-300 w-full shadow-sm mt-1 h-12 p-2"
                                    value="" />
                            </div>
                            <div>
                                <label for="password" class="inline-block text-sm font-medium">
                                ...
                                <input type="password" id="" name="password" required="" placeholder=""
                                    autocomplete="current-password"
                                    class="border border-gray-300 w-full shadow-sm mt-1 h-12 p-2" />
                            </div>
                            <div>
                                ...
                                <input type="password" id="" name="password_confirmation" required=""
